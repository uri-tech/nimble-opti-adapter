...
func main() {
	...
	// Get the kubernetes.Interface from the manager
	...
	// Create a new SharedInformerFactory with the kubernetes.Interface
	...
	// Start the informers
	informerFactory.Start(ctrl.SetupSignalHandler().Done())
